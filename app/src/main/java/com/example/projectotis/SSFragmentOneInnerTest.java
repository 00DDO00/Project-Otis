...
public class SSFragmentOneInnerTest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("TutorDataSS").child("Data1");
        databaseReferenceName = firebaseDatabase.getReference("TutorNameSS").child("Name1");
...
/*
        ...
        Drawable myDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.mclovin, null);
