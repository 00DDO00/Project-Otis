...
public class SSSFragmentTwoInnerTest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("TutorDataSSS").child("Data2");
        databaseReferenceName = firebaseDatabase.getReference("TutorNameSSS").child("Name2");
...
/*
        ...
        Drawable myDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.bensu, null);
