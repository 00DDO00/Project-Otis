    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent I = new Intent(ActivityLogin.this, com.example.projectotis.UserActivity.class);
                    startActivity(I);
                } else {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent I = new Intent(ActivityLogin.this, com.example.projectotis.SignUpActivity.class);
                startActivity(I);
            }
        });
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(ActivityLogin.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                ...
                                startActivity(new Intent(ActivityLogin.this, com.example.projectotis.UserActivity.class));
                            }
                        }
                    });
                } else {
