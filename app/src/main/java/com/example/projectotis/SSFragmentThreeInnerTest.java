...
public class SSFragmentThreeInnerTest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("TutorDataSS").child("Data3");
        databaseReferenceName = firebaseDatabase.getReference("TutorNameSS").child("Name3");
        ...
        Drawable myDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.tigerwoods, null);
