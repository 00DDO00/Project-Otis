...
public class SSFragmentTwoInnerTest extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("TutorDataSS").child("Data2");
        databaseReferenceName = firebaseDatabase.getReference("TutorNameSS").child("Name2");
...
/*
        ...
        img = (ImageView) root.findViewById(R.id.lawyerPhoto2);


        Drawable myDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.picdaniels, null);
