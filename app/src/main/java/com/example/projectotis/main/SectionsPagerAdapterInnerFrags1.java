 ...
 */
public class SectionsPagerAdapterInnerFrags1 extends FragmentPagerAdapter {

    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab_text_1, R.string.tab_text_2};
    private final FragmentOne mContext;

    public SectionsPagerAdapterInnerFrags1(FragmentOne fragmentOne, FragmentManager fm) {
        super(fm);
        mContext = fragmentOne;
    }
