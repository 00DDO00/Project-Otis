 ...
 */
public class SectionsPagerAdapterInnerFrags2 extends FragmentPagerAdapter {

    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.tab_text_1, R.string.tab_text_2};
    private final FragmentTwo mContext;

    public SectionsPagerAdapterInnerFrags2(FragmentTwo fragmentTwo, FragmentManager fm) {
        super(fm);
        mContext = fragmentTwo;
    }
